...
- [x] User can swipe on Register view to travel back to Lopgin view.
...
<img src='http://g.recordit.co/HoPc5r1ZUj.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Need to be more efficient with commenting.
- Organize my code neater.
- Did a better job at committing.
